...
\end{minipage}} \\
\par The provided data are \textit{q\_2\_5\_tm\_10node\_20sample\_4clusters}, \textit{q\_2\_5\_tm\_10node\_50sample\_4clusters}, and \textit{q\_2\_5\_tm\_20node\_20sample\_4clusters}.

\par First, compare the real and inferred trees with the unweighted RF metric, 

\par Then compare the likelihoods of real and inferred mixtures 
...
%	\par Evaluate $\bm{\theta}^{\mathrm{new}}$ given by
%	\begin{align*}
