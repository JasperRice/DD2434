...
\end{align*}
\par Conditional probability densities (CPDs). The algorithm is implemented as:\lstinputlisting[caption=EM algorithm for mixture of trees with observable variables.]{Code/2_5.py}
